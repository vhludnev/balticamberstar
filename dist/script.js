...
var checkMailInputs = function checkMailInputs(selector) {
...
var checkNameInputs = function checkNameInputs(selector) {
...
var messagesRef = firebase.database().ref('messages'); // Form submit to Firebase
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      /* constructing the spinner that will appear after submitting the form */

      statusImg.setAttribute('src', message.spinner);
      statusImg.classList.add('animated', 'fadeInUp');
      statusMessage.appendChild(statusImg);
      var textMessage = document.createElement('div');
      /* constructing the block for the text that will appear after submitting the form */
      ...
      api = path.question;
      /* if we find '.popup-design' -> send to designer, other wise to question */
      ...
      /* will add all enetered in form data to one append after clicking Submit on the last popup window*/
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_5__["postData"])(api, formData).then(function (res) {
        ...
        clearInputs(); //                    document.calcform.reset(); /* Clears choices made in the Calculator [name=calcform] */
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_menuTabs__WEBPACK_IMPORTED_MODULE_9__["default"])(); //metrika();
});
...
var addPortfoliosToHtml = function addPortfoliosToHtml(
/* trigger, */
wrapper) {
  Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json') //        getResource('http://localhost:3000/styles') /* if using json-server */
  .then(function (res) {
    return createPortfolios(res.cards);
  })
  ...
  function createPortfolios(response) {
    ...
    response.forEach(function (_ref) {
      ...
      card.classList.add('portfolio-block', 'all', "".concat(relate));
      card.innerHTML = "\n                     <img class=\"myImg\" src=\"assets/img/gallery/Portfolio".concat(src, "-1.webp\" alt=").concat(alt, " loading=\"lazy\">\n                ");
...
var addSlickSlidesToHtml = function addSlickSlidesToHtml(wrapper) {
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      style.innerHTML = "\n             <img class=\"myImg\" src=\"assets/img/gallery/Slide".concat(src, "-1.webp\" alt=").concat(alt, " loading=\"lazy\">\n        ");
...
var filter = function filter() {
  try {
    ...
    btnAthome.addEventListener('click', function () {
    ...
    btnOthers.addEventListener('click', function () {
      typeFilter(markOthers);
      /* if no pictures in the category leave like that: typeFilter(); to see "No pictures" on the screen*/
...
var lang_switch = function lang_switch() {
  ///// Jquery lang switch
  var arrLang = {
    'en': {
      'home': 'Home',
  ...
  var lang = localStorage.getItem('lang') || navigator.language.slice(0, 2); // Or setting the default language to English
...
var menuTabs = function menuTabs() {
  $('#navmenu ul li a').click(function () {
    $('li a').removeClass("active");
    $(this).addClass("active");
    localStorage.setItem('page', $(this).parent().index());
  });
  var ele = localStorage.getItem('page');
  $('#navmenu ul li:eq(' + ele + ')').find('a').addClass('active');
  localStorage.removeItem('page');
  /* if not set, menu tab will be hightlighted after returning back to the website */
};
...
var modalSliders = function modalSliders(wrapperBlock) {
  var thumbnails = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  try {
    ...
    wrapper.addEventListener('click', function (e) {
      ...
      if (target && target.classList.contains('myImg')) {
        ...
        setTimeout(function () {
          ...
          /* will remove mouse scrolling when the img is popped up */
        }, 700);
      }
    ...
    span.addEventListener('click', function () {
      ...
      document.body.style.marginRight = "0px";
      document.body.style.overflow = "";
      /* will restore mouse scrolling after closing the modal window */
    });
  } catch (e) {}
